          ...
          <div class="col-md-3">
           ...
           <div class="card card-default">
              <div class="card-header">
                ...
                <div class="card-tools">
                   @if($product->post_mime_type!=null) 
                     <input type="checkbox" checked  name="featured_product" value="{{$product->post_mime_type}}">
                     @else 
                     <input type="checkbox" name="featured_product" value="featured">
                   @endif
                </div>
              </div>
            </div>
            ...
            <div class="card card-default">
              ...
              <div class="card-body" style="display: block;height:250px;overflow-x:scroll">
                ...
                @endphp
                 <input type="checkbox" id="{{$category->term_id}}" {{($check==true)?'checked':''}} name="category[]" value="{{$category->term_id}}">
