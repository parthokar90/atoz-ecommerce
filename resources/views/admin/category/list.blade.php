      ...
      <div class="row">
        <div class="col-md-5">
          <div class="card card-primary">
            ...
            <!-- form start -->
            @if(isset($category))
            <form role="form" method="POST" action="{{route('category.update',$category->term_id)}}" enctype="multipart/form-data">
              {{ csrf_field() }}
              {{ method_field('PATCH') }}
              <div class="card-body">
                <div class="form-group">
                 ...
                 <label for="term_group_level">Select Parent</label>
                    ...
                    <!-- <label for="term_group_level">Child to Child</label>
                   ...
                   <div class="form-group mt-2">
                      <img class="mt-2 mb-2" width="50px" height="50px" src="{{asset('backend/category/'.$category->cat_image)}}"><br>
                      <label for="term_group_level">Image</label>
                      <input class="form-control" type="file" name="cat_image" accept="image/*">
                      <input  type="hidden" name="default_cat_image" value="{{$category->cat_image}}">
                   </div>
                  ...
                  <div class="form-group">
                      <label>Show Home Page Category Section??</label>
                   ...
                   <div class="form-group">
                     <label>Order</label>
                     <input class="form-control" type="number" value="{{$category->count}}" name="order">
                   </div>
                ...
                <table class="table table-bordered table-striped">
                  <thead class="bg-info">                  
                    <tr>
                      ...
                      <th>Image</th>
                      <th>Category Name</th>
                      <th>Home Page Category Section</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$i}}</td>
                      <td><img class="mt-2 mb-2" width="50px" height="50px" src="{{asset('backend/category/'.$value->cat_image)}}"></td>
                      <td>{{$value->name}}</td>
                      <td>@if($value->cat_status==1) Active @else Inactive @endif</td>
                      <td>Active</td>
                            <td>{{$value->count}}</td>
                      <td>
