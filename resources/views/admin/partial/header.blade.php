    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('admin.home')}}" class="brand-link text-center" style="background: #e7e7e7;">
                <img src="{{asset('assets/common/images/logo.png')}}" alt="Ecommerce Logo" class=""
                ...
                <nav class="mt-2">
                   ...
                   <!-- role for admin and route  -->
                       ...
                       @if($user->can('create-category'))
                        ...
                        <li class="nav-item">
                            <a href="{{route('review_list')}}"
                                class="nav-link {{isset($page) && $page=='review_list'?'active':''}}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Customer Review
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{route('subscribe_list')}}"
                                class="nav-link {{isset($page) && $page=='subscribe_list'?'active':''}}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Email Subscription
                                </p>
