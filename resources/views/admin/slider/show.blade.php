...
<div class="content-wrapper" style="min-height: 1203.6px;">
	...
	<section class="content">
        ...
        @include('admin.includes.messages')
            ...
            <form role="form" method="POST" action="{{route('slider.update',$list->ID)}}" enctype="multipart/form-data"> 
			@method('PATCH') 
            @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="slider_img" class="form-control" accept="image/x-png,image/gif,image/jpeg">
                                        <img width="50px" height="50px" src="{{asset('backend/slider/'.$slider_image)}}">
                                        <input type="hidden" name="d_image" value="{{$slider_image}}">
                                    </div>

                                    <div class="form-group">
                                        <label>Url</label>
                                        <input type="text" class="form-control" value="{{$slider_url}}" name="slider_url" autocomplete="off">
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                           @if($list->post_status=='publish')
                                             <option value="{{$list->post_status}}" selected>{{ucfirst($list->post_status)}}</option>
