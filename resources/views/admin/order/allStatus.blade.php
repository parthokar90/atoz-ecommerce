...
<div class="content-wrapper" style="min-height: 1203.6px;">
  ...
  <div class="s002">
    ...
    <div class="d-flex justify-content-center mb-3">
      <form class="form-inline" method="get" action="{{route('order.all.status.search')}}">
          ...
          <table class="table table-striped text-center">
            ...
            <tbody>
              ...
              <tr style="background: #ffffff;">
                ...
                <td class="right">@if($orders->post_status=='dispatch_complete') Dispatch_Complete @else {{ucfirst($orders->post_status)}} @endif</td>
                <td class="text-center">
                <!--   <a href="{{route('order.allStatus.print',$orders->ID)}}" class="btn btn-success mb-2"> <i class="fas fa-print"> </i> Print</a> -->
                  <a href="{{route('pending_order_print',$orders->ID)}}" class="btn btn-success mb-2"> <i class="fas fa-print"> </i> Print</a>
            ...
            <!--       <a href="{{route('download.shipping.address',$orders->ID)}}" class="btn btn-info btn-sm mt-2"> <i class="fas fa-edit"> </i> Shipping Address</a> -->
                  <br>
                </td>
              </tr>
              @endforeach
