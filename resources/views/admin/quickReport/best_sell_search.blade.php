...
<div class="content-wrapper" style="min-height: 1203.6px;">
  ...
  <section class="content">
    <div class="container">
         <h4 class="text-center">Best Sell Items from {{date('d-m-Y',strtotime($start))}} to {{date('d-m-Y',strtotime($end))}}</h4>
      <div class="card">
        <div class="card-body">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="right">{{$item->total_qty}} pcs @php $total_qty+=$item->total_qty; @endphp</td>
                  <td class="right">
                  @php 
                  ...
                  @endphp 
                  @if(isset($cost)) 
                    {{number_format($cost->meta_value)}} tk @php $total_cost+=$cost->meta_value; @endphp
                  @endif
                </td>
                  <td class="right">
                    @php 
