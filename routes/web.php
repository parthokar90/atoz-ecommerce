...
Route::group(['middleware' => 'role:admin'], function() {
    ...
    Route::group(['namespace'=>'Front'],function(){
          Route::post('review/product','PageController@userProductReview')->name('user_product_review');
          Route::get('product/category/item/{id}','HomeController@catItemProduct')->name('pro_cat');
        Route::get('/customer-checkout','CartController@cartCheckout')->name('checkout_cart');
        Route::post('/discount/coupon','CartController@DiscountCoupon');
         Route::post('mail-user-subscribe','PageController@subscribeMail')->name('subscribe_mail');
    ...
    Route::group(['namespace'=>'Admin'],function(){       
        ...
        Route::get('/review/list','ProductController@ReviewList')->name('review_list');
        Route::get('/mail/subscribe/list','ProductController@mail_subscribe_list')->name('subscribe_list');
        Route::get('/subscribe/send/email/{id}','ProductController@mail_subscribe_list_send')->name('send_subscribe_email');
        Route::post('mail-user-subscribe-send','ProductController@subscribeMailSend')->name('subscribe_mail_send');
        Route::get('/review/list/action/{id}/{status}','ProductController@ReviewListAction');
        Route::get('/review/list/delete/{id}','ProductController@ReviewListDelete');
        Route::get('/review/list/details/{id}','ProductController@ReviewListDetails');
